...
public class CameraTransformCorrection : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // This is only in case the wrong object was moved when position the camera
        cameraProxy.transform.position = GetComponent<Transform>().position;
        cameraProxy.transform.rotation = GetComponent<Transform>().rotation;
    }
